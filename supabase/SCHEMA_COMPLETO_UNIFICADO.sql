-- ==============================================================================
-- 🌸 IASIS AGENDA - SCRIPT SQL COMPLETO E UNIFICADO (100% COMPATÍVEL COM SUPABASE)
-- Execute este arquivo no SQL Editor do Supabase para criar:
-- 1. Todas as 22 Tabelas do Sistema
-- 2. Regras de Segurança e Isolamento RLS
-- 3. Anamnese, Evoluções, Fotos, Estoque, Financeiro, Caixa, Pacotes, Fidelidade e CRM
-- 4. Dados Demonstrativos Iniciais (Seed com UUIDs válidos)
-- ==============================================================================

-- Habilita extensões para UUID e criptografia
...
-- Função auxiliar de atualização de data (updated_at)
...
-- 2. Profiles (Vínculo com Auth do Supabase)
...
-- 3. Professionals (Profissionais da Clínica)
...
-- 4. Professional Work Schedules (Escala Semanal)
...
-- 5. Schedule Blocks (Bloqueios de Agenda)
...
-- 13. Financial Transactions & Categories
...
-- 15. Anamnesis Templates & Records
...
-- 21. CRM, Settings & Smart Follow-ups
...
-- Permissões para equipe autenticada
CREATE POLICY "Authenticated staff have full access" ON business_settings FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON profiles FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON professionals FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON professional_schedules FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON schedule_blocks FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON service_categories FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON services FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON professional_services FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON clients FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON appointments FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON appointment_status_history FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON notification_templates FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON financial_categories FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON financial_transactions FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON cash_registers FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON cash_movements FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON anamnesis_templates FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON anamnesis_records FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON products FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON treatment_evolutions FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON treatment_photos FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON packages FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON client_packages FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON promotions FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON loyalty_accounts FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON commission_records FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON crm_settings FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON client_follow_ups FOR ALL TO authenticated USING (TRUE);
CREATE POLICY "Authenticated staff have full access" ON client_recovery_logs FOR ALL TO authenticated USING (TRUE);

-- ==============================================================================
-- DADOS INICIAIS (SEED COM UUIDs 100% VÁLIDOS EM HEXADECIMAL: 0-9 e a-f)
-- ==============================================================================
